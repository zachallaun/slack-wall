...
function toggleFab() {                  //does not re-initialize the conversation, just toggles visibility. 
...
// if (readCookie('fab_chat_username') === null || readCookie('fab_chat_email') === null) {  // this sets up a login screen. 
//   logUser();
// } else {
//   hideChat(false);
// }